...
jstring JNICALL
Java_com_example_object_1detection_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
// 调用jni对文件进行处理
void JNICALL
Java_com_example_object_1detection_MainActivity_inityolo(
        JNIEnv *env,
        jobject obj,
        jstring cfgfile,
        jstring weightfile) {
...
//将img传到sdcard上
jdouble JNICALL
Java_com_example_object_1detection_MainActivity_testyolo(
        JNIEnv *env,
        jobject obj,
        jstring imgfile) {
//    double time;
...
jboolean JNICALL
Java_com_example_object_1detection_MainActivity_detectimg(
        JNIEnv *env,
        jobject obj,
        jobject dst,
        jobject src) {
